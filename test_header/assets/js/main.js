...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var scroll_lock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
...
document.addEventListener("DOMContentLoaded", function (domLoadedEvent) {
	...
	let hideSearch = function (e) {
		...
		if (!isSearch) {
			...
			searchBtn.addEventListener('click', showSearch, { once: true });
		}
	}
	...
	if (modal) {
		for (let i = 0; i < modalOpenBtns.length; i++) {
			...
			function openModal(e) {
				...
				scroll_lock__WEBPACK_IMPORTED_MODULE_0___default.a.disablePageScroll(modal);
			...
			function closeModal(e) {
				...
				scroll_lock__WEBPACK_IMPORTED_MODULE_0___default.a.enablePageScroll(modal);
