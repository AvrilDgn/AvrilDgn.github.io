...
var lightgallery = __webpack_require__(6);

// EXTERNAL MODULE: ./node_modules/lg-zoom.js/dist/lg-zoom.js
var lg_zoom = __webpack_require__(2);
...
var lg_thumbnail = __webpack_require__(3);
...
var simpleParallax_min = __webpack_require__(4);
...
document.addEventListener("DOMContentLoaded", function (domLoadedEvent) {
	...
	new simpleParallax_min_default.a(parallaxImages, {
		delay: .8,
		overflow: true,
	});
	...
	let hallsSlider = new core_class('.halls-list__slider .halls-list__wrapper', {
		spaceBetween: 15,
		wrapperClass: 'halls-list__list',
		slideClass: 'halls-list__item',
		slidesPerView: 1,
		watchSlidesVisibility: true,
	...
	let hallsShowAllBtn = document.querySelector('.halls-list__all-halls');
	...
	new core_class('.promotions__slider .promotions__wrapper', {
		spaceBetween: 30,
		wrapperClass: 'promotions__list',
		slideClass: 'promotions__item',
		slidesPerView: 1,
		watchSlidesVisibility: true,
		watchOverflow: true,

		navigation: {
			nextEl: ".promotions__arrow.arrow--next",
	...
	new core_class('.about__slider .about__wrapper', {
		spaceBetween: 30,
		...
		navigation: {
			nextEl: ".about__arrow.arrow--next",
			prevEl: ".about__arrow.arrow--prev",
			disabledClass: 'arrow--disabled',
		},
	});
	...
	if (hallThumbEl && hallMainEl) {
		...
		hallSliderThumb.on('transitionStart', function () {
			addMorePhoto();
		});
		...
		hallSliderMain.on('slideNextTransitionStart', function () {
			...
			hallSliderMain.enabled = false;

		});

		hallSliderMain.on('slideNextTransitionEnd', function () {
			hallSliderMain.enabled = true;
		});
		...
		hallSliderMain.on('slidePrevTransitionEnd', function () {
			hallSliderMain.enabled = true;
		});
	...
	for (const ratingIndex in rating) {
		if (Object.hasOwnProperty.call(rating, ratingIndex)) {
			const element = rating[ratingIndex];
			const ratingNumber = element.dataset.rating;
			let stars = element.querySelectorAll('.rating__item');

			for (let i = 0; i < ratingNumber; i++) {
				stars[i].classList.add('rating__item--active');
			}
		}
	}
	...
	reviewsShowBtn.addEventListener('click', function (e) {
		...
		new DLAnimate().hide(reviewsShowBtn, {
			name: 'fade',
			track: 'animation',
			duration: 200
		});
