...
function _rollupPluginBabelHelpers_a0b34764_defineProperties(target, props) {
...
function _rollupPluginBabelHelpers_a0b34764_createClass(Constructor, protoProps, staticProps) {
  if (protoProps) _rollupPluginBabelHelpers_a0b34764_defineProperties(Constructor.prototype, protoProps);
  if (staticProps) _rollupPluginBabelHelpers_a0b34764_defineProperties(Constructor, staticProps);
  return Constructor;
}
...
function _inherits(subClass, superClass) {
  ...
  if (superClass) _rollupPluginBabelHelpers_a0b34764_setPrototypeOf(subClass, superClass);
}

function _rollupPluginBabelHelpers_a0b34764_getPrototypeOf(o) {
  _rollupPluginBabelHelpers_a0b34764_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {
    return o.__proto__ || Object.getPrototypeOf(o);
  };
  return _rollupPluginBabelHelpers_a0b34764_getPrototypeOf(o);
}

function _rollupPluginBabelHelpers_a0b34764_setPrototypeOf(o, p) {
  _rollupPluginBabelHelpers_a0b34764_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {
    o.__proto__ = p;
    return o;
  };

  return _rollupPluginBabelHelpers_a0b34764_setPrototypeOf(o, p);
}

function _rollupPluginBabelHelpers_a0b34764_isNativeReflectConstruct() {
  if (typeof Reflect === "undefined" || !Reflect.construct) return false;
  if (Reflect.construct.sham) return false;
  if (typeof Proxy === "function") return true;
...
function _rollupPluginBabelHelpers_a0b34764_assertThisInitialized(self) {
  if (self === void 0) {
    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
  }
...
function _possibleConstructorReturn(self, call) {
  ...
  return _rollupPluginBabelHelpers_a0b34764_assertThisInitialized(self);
}

function _createSuper(Derived) {
  var hasNativeReflectConstruct = _rollupPluginBabelHelpers_a0b34764_isNativeReflectConstruct();

  return function _createSuperInternal() {
    var Super = _rollupPluginBabelHelpers_a0b34764_getPrototypeOf(Derived),
        result;

    if (hasNativeReflectConstruct) {
      var NewTarget = _rollupPluginBabelHelpers_a0b34764_getPrototypeOf(this).constructor;
...
function _superPropBase(object, property) {
  while (!Object.prototype.hasOwnProperty.call(object, property)) {
    object = _rollupPluginBabelHelpers_a0b34764_getPrototypeOf(object);
...
function _rollupPluginBabelHelpers_a0b34764_set(target, property, value, receiver) {
  if (typeof Reflect !== "undefined" && Reflect.set) {
    _rollupPluginBabelHelpers_a0b34764_set = Reflect.set;
  } else {
    _rollupPluginBabelHelpers_a0b34764_set = function set(target, property, value, receiver) {
      var base = _superPropBase(target, property);
  ...
  return _rollupPluginBabelHelpers_a0b34764_set(target, property, value, receiver);
}

function _set(target, property, value, receiver, isStrict) {
  var s = _rollupPluginBabelHelpers_a0b34764_set(target, property, value, receiver || target);
...
var action_details_ActionDetails = /*#__PURE__*/function () {
  ...
  */
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(ActionDetails, [{
    key: "startChangePos",
    get: function get() {
...
var change_details_ChangeDetails = /*#__PURE__*/function () {
  ...
  */
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(ChangeDetails, [{
    key: "aggregate",
...
var continuous_tail_details_ContinuousTailDetails = /*#__PURE__*/function () {
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(ContinuousTailDetails, [{
    key: "toString",
...
var base_Masked = /*#__PURE__*/function () {
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(Masked, [{
    key: "updateOptions",
    ...
    */
    ...
    value: function splice(start, deleteCount, inserted, removeDirection) {
      ...
      var changeDetails = new change_details_ChangeDetails({
...
var input_definition_PatternInputDefinition = /*#__PURE__*/function () {
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(PatternInputDefinition, [{
    key: "reset",
    value: function reset() {
    ...
    value: function _appendChar(str) {
      var flags = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      if (this._isFilled) return new change_details_ChangeDetails();
...
var fixed_definition_PatternFixedDefinition = /*#__PURE__*/function () {
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(PatternFixedDefinition, [{
    key: "value",
    get: function get() {
      return this._value;
    }
...
var chunk_tail_details_ChunksTailDetails = /*#__PURE__*/function () {
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(ChunksTailDetails, [{
    key: "toString",
    value: function toString() {
...
var regexp_MaskedRegExp = /*#__PURE__*/function (_Masked) {
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(MaskedRegExp, [{
    key: "_update",
    value:
    /**
      @override
    ...
    */
    function _update(opts) {
      ...
      _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedRegExp.prototype), "_update", this).call(this, opts);
    }
  }]);
...
var pattern_MaskedPattern = /*#__PURE__*/function (_Masked) {
  ...
  */
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(MaskedPattern, [{
    key: "_update",
    value: function _update() {
      var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      opts.definitions = Object.assign({}, this.definitions, opts.definitions);

      _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedPattern.prototype), "_update", this).call(this, opts);
    ...
    value: function _rebuildMask() {
      ...
      for (var i = 0; i < pattern.length; ++i) {
        ...
        var def = _isInput ? new input_definition_PatternInputDefinition({
          parent: this,
          lazy: this.lazy,
    ...
    */
    ...
    key: "state",
    get: function get() {
      return Object.assign({}, _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedPattern.prototype), "state", this), {
    ...
    set: function set(state) {
      ...
      _set(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedPattern.prototype), "state", maskedState, this, true);
    }
    /**
      @override
    */
    ...
    key: "reset",
    value: function reset() {
      _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedPattern.prototype), "reset", this).call(this);
    ...
    */
    ...
    value: function doCommit() {
      ...
      _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedPattern.prototype), "doCommit", this).call(this);
    }
    /**
      @override
    */
    ...
    set: function set(unmaskedValue) {
      _set(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedPattern.prototype), "unmaskedValue", unmaskedValue, this, true);
    }
    /**
      @override
    */
    ...
    set: function set(value) {
      _set(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedPattern.prototype), "value", value, this, true);
    }
    /**
      @override
    */
    ...
    key: "appendTail",
    value: function appendTail(tail) {
      return _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedPattern.prototype), "appendTail", this).call(this, tail).aggregate(this._appendPlaceholder());
    }
    /**
      @override
    */
    ...
    */
    ...
    value: function remove() {
      ...
      var removeDetails = _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedPattern.prototype), "remove", this).call(this, fromPos, toPos);
...
var range_MaskedRange = /*#__PURE__*/function (_MaskedPattern) {
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(MaskedRange, [{
    key: "_matchFrom",
    get:
    /**
    ...
    */
    ...
    value: function _update(opts) {
      ...
      _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedRange.prototype), "_update", this).call(this, opts);
    }
    /**
      @override
    */
    ...
    key: "isComplete",
    get: function get() {
      return _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedRange.prototype), "isComplete", this) && Boolean(this.value);
    }
  }, {
    key: "boundaries",
    ...
    */
    ...
    value: function doPrepare(str) {
      var flags = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      str = _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedRange.prototype), "doPrepare", this).call(this, str, flags).replace(/\D/g, '');
    ...
    */
    ...
    value: function doValidate() {
      ...
      return this.from <= Number(maxstr) && Number(minstr) <= this.to && (_get2 = _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedRange.prototype), "doValidate", this)).call.apply(_get2, [this].concat(args));
    }
  }]);
...
var date_MaskedDate = /*#__PURE__*/function (_MaskedPattern) {
  ...
  */
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(MaskedDate, [{
    key: "_update",
    value: function _update(opts) {
      ...
      _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedDate.prototype), "_update", this).call(this, opts);
    }
    /**
      @override
    */
    ...
    value: function doValidate() {
      ...
      return (_get2 = _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedDate.prototype), "doValidate", this)).call.apply(_get2, [this].concat(args)) && (!this.isComplete || this.isDateExist(this.value) && date != null && (this.min == null || this.min <= date) && (this.max == null || date <= this.max));
    }
    ...
    */
    ...
    key: "typedValue",
    get: function get() {
      return this.isComplete ? _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedDate.prototype), "typedValue", this) : null;
    },
    set: function set(value) {
      _set(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedDate.prototype), "typedValue", value, this, true);
    }
  }]);
...
var mask_element_MaskElement = /*#__PURE__*/function () {
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(MaskElement, [{
    key: "selectionStart",
    get:
    /** */
...
var html_mask_element_HTMLMaskElement = /*#__PURE__*/function (_MaskElement) {
  ...
  */
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(HTMLMaskElement, [{
    key: "rootElement",
    get: function get() {
...
var html_contenteditable_mask_element_HTMLContenteditableMaskElement = /*#__PURE__*/function (_HTMLMaskElement) {
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(HTMLContenteditableMaskElement, [{
    key: "_unsafeSelectionStart",
    get:
    /**
      Returns HTMLElement selection start
...
var input_InputMask = /*#__PURE__*/function () {
  ...
  */
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(InputMask, [{
    key: "mask",
    get: function get() {
    ...
    value: function maskEquals(mask) {
      return mask == null || mask === this.masked.mask || mask === Date && this.masked instanceof date_MaskedDate;
    }
  }, {
    key: "value",
    get: function get() {
...
var enum_MaskedEnum = /*#__PURE__*/function (_MaskedPattern) {
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(MaskedEnum, [{
    key: "_update",
    value:
    /**
      @override
    ...
    */
    function _update(opts) {
      ...
      _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedEnum.prototype), "_update", this).call(this, opts);
    }
    /**
      @override
    */
    ...
    value: function doValidate() {
      ...
      }) && (_get2 = _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedEnum.prototype), "doValidate", this)).call.apply(_get2, [this].concat(args));
    }
  }]);
...
var number_MaskedNumber = /*#__PURE__*/function (_Masked) {
  ...
  */
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(MaskedNumber, [{
    key: "_update",
    value: function _update(opts) {
      _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedNumber.prototype), "_update", this).call(this, opts);
    ...
    */
    ...
    value: function doPrepare(str) {
      ...
      return (_get2 = _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedNumber.prototype), "doPrepare", this)).call.apply(_get2, [this, this._removeThousandsSeparators(str.replace(this._mapToRadixRegExp, this.radix))].concat(args));
    }
    /** */
    ...
    */
    ...
    value: function extractInput() {
      ...
      return this._removeThousandsSeparators(_get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedNumber.prototype), "extractInput", this).call(this, fromPos, toPos, flags));
    }
    /**
      @override
    */
    ...
    value: function _appendCharRaw(ch) {
      var flags = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      if (!this.thousandsSeparator) return _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedNumber.prototype), "_appendCharRaw", this).call(this, ch, flags);
      ...
      var appendDetails = _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedNumber.prototype), "_appendCharRaw", this).call(this, ch, flags);
    ...
    */
    ...
    value: function doValidate(flags) {
      ...
      return valid && _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedNumber.prototype), "doValidate", this).call(this, flags);
    }
    /**
      @override
    */
    ...
    value: function doCommit() {
      ...
      _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedNumber.prototype), "doCommit", this).call(this);
    }
    /** */
    ...
    */
    ...
    set: function set(unmaskedValue) {
      _set(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedNumber.prototype), "unmaskedValue", unmaskedValue.replace('.', this.radix), this, true);
    }
    /**
      @override
    */
    ...
    set: function set(n) {
      _set(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedNumber.prototype), "unmaskedValue", String(n), this, true);
    }
    /** Parsed Number */
...
var function_MaskedFunction = /*#__PURE__*/function (_Masked) {
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(MaskedFunction, [{
    key: "_update",
    value:
    /**
      @override
    ...
    */
    function _update(opts) {
      ...
      _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedFunction.prototype), "_update", this).call(this, opts);
    }
  }]);
...
var dynamic_MaskedDynamic = /*#__PURE__*/function (_Masked) {
  ...
  */
  ...
  _rollupPluginBabelHelpers_a0b34764_createClass(MaskedDynamic, [{
    key: "_update",
    value: function _update(opts) {
      _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedDynamic.prototype), "_update", this).call(this, opts);
    ...
    */
    ...
    value: function doValidate() {
      ...
      return (_get2 = _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedDynamic.prototype), "doValidate", this)).call.apply(_get2, [this].concat(args)) && (!this.currentMask || (_this$currentMask = this.currentMask).doValidate.apply(_this$currentMask, args));
    }
    /**
      @override
    */
    ...
    */
    ...
    set: function set(value) {
      _set(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedDynamic.prototype), "value", value, this, true);
    }
    /**
      @override
    */
    ...
    set: function set(unmaskedValue) {
      _set(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedDynamic.prototype), "unmaskedValue", unmaskedValue, this, true);
    }
    /**
      @override
    */
    ...
    */
    ...
    key: "state",
    get: function get() {
      return Object.assign({}, _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedDynamic.prototype), "state", this), {
    ...
    set: function set(state) {
      ...
      _set(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedDynamic.prototype), "state", maskedState, this, true);
    }
    /**
      @override
    */
    ...
    */
    ...
    value: function extractTail() {
      ...
      return this.currentMask ? (_this$currentMask4 = this.currentMask).extractTail.apply(_this$currentMask4, args) : (_get3 = _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedDynamic.prototype), "extractTail", this)).call.apply(_get3, [this].concat(args));
    }
    /**
      @override
    */
    ...
    value: function doCommit() {
      ...
      _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedDynamic.prototype), "doCommit", this).call(this);
    }
    /**
      @override
    */
    ...
    value: function nearestInputPos() {
      ...
      return this.currentMask ? (_this$currentMask5 = this.currentMask).nearestInputPos.apply(_this$currentMask5, args) : (_get4 = _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedDynamic.prototype), "nearestInputPos", this)).call.apply(_get4, [this].concat(args));
    }
  }, {
    key: "overwrite",
    get: function get() {
      return this.currentMask ? this.currentMask.overwrite : _get(_rollupPluginBabelHelpers_a0b34764_getPrototypeOf(MaskedDynamic.prototype), "overwrite", this);
    },
...
document.addEventListener("DOMContentLoaded", function (domLoadedEvent) {
	...
	const smMedia = window.matchMedia("(max-width: 768px)");
	...
	let headerCollapse = document.querySelector('.header__sub-group');
	let headerShown;

	let hideMobHeader = function () {
		headerToggleBtn.classList.remove('header__toggle-btn--rotate');
		...
		headerToggleBtn.addEventListener('transitionend', () => {
			...
			headerToggleBtn.addEventListener('transitionend', () => {
				...
				headerCollapse.addEventListener('transitionend', () => {
					...
					// scrollLock.enablePageScroll(header);
					headerShown = false;
				}, { once: true });
			}, { once: true });
		}, { once: true });
	...
	let showMobHeader = function () {
		// scrollLock.disablePageScroll(header);
		headerShown = true;

		headerToggleBtn.classList.add('header__toggle-btn--compress');

		headerToggleBtn.addEventListener('transitionend', () => {
			headerToggleBtn.classList.add('header__toggle-btn--rotate');

			headerToggleBtn.addEventListener('transitionend', () => {

				headerCollapse.style.height = 'initial';
				...
				raf(() => {
					raf(() => {
						headerCollapse.style.height = height > windowHeight ? height + 'px' : windowHeight + 'px';
	...
	let phoneInputs = document.querySelectorAll('.phoneMask');
	...
	//screen sliders
	let screenSliders = document.querySelectorAll('.screen .screen__slider');

	screenSliders.forEach(slider => {
		new core_class(slider, {
			spaceBetween: 30,
			wrapperClass: 'screen__list',
			slideClass: 'screen__item',
			slidesPerView: 1,
			watchOverflow: true,
			loop: true,
			autoplay: {
			...
			navigation: {
				nextEl: ".screen__arrow.slider-arrow--next",
				prevEl: ".screen__arrow.slider-arrow--prev",
	...
	//shop sliders
	let shopSliders = document.querySelectorAll('.shop-card__slider');

	shopSliders.forEach(slider => {
		new core_class(slider, {
			spaceBetween: 30,
			wrapperClass: 'shop-card__list',
			slideClass: 'shop-card__item',
			slidesPerView: 1,
			watchOverflow: true,
			loop: true,

			pagination: {
				el: ".shop-card__pagination",
				clickable: true,
				bulletElement: 'li',
			},

			navigation: {
				nextEl: ".shop-card__arrow.slider-arrow--next",
				prevEl: ".shop-card__arrow.slider-arrow--prev",
				disabledClass: 'slider-arrow--disabled',
			},
		});
	});
	...
	let reviewsSlider = new core_class('.reviews__slider .reviews__wrapper', {
		...
		navigation: {
			nextEl: ".reviews__arrows-mobile-group .reviews__arrow.slider-arrow--next",
			prevEl: ".reviews__arrows-mobile-group .reviews__arrow.slider-arrow--prev",
			disabledClass: 'slider-arrow--disabled',
		},
		...
		breakpoints: {
			'768': {
				slidesPerView: 1,
				navigation: {
					nextEl: ".reviews__slider > .reviews__arrow.slider-arrow--next",
					prevEl: ".reviews__slider > .reviews__arrow.slider-arrow--prev",
					disabledClass: 'slider-arrow--disabled',
				},
			},
			'900': {
	...
	function actCouresSlider(lg) {
		if (lg.matches) {
			coursesSlider = new core_class('.courses--short .courses__wrapper', {
				spaceBetween: 30,
				wrapperClass: 'courses__list',
				slideClass: 'courses__item',
				slidesPerView: 1,
				watchOverflow: true,
				loop: true,
				...
				navigation: {
					nextEl: ".courses__arrow.slider-arrow--next",
					prevEl: ".courses__arrow.slider-arrow--prev",
					disabledClass: 'slider-arrow--disabled',
				},
			...
			if (coursesSlider) {
				coursesSlider.destroy();
			}
		}
	}

	actCouresSlider(lgMedia);

	lgMedia.addListener(actCouresSlider);


	/**
	 * Background figures movement
	 */

	let figures = document.querySelectorAll('.background-figures__item');
	...
	figures.forEach(figure => {
		let posX = getRandomInt(-20, 20),
			poxY = getRandomInt(-20, 20);

		figure.style.transform = `translate(${posX}px,${poxY}px)`;

		figure.addEventListener('transitionend', function (e) {
			posX = getRandomInt(-20, 20);
			poxY = getRandomInt(-20, 20);
	...
	let substrates = document.querySelectorAll('.block-with-substrate');
	...
	substrates.forEach(sub => {
		...
		function Visible(target) {
			...
			if (targetPosition.bottom > windowPosition.top + 50 &&
				targetPosition.top < windowPosition.bottom - 50 &&
				targetPosition.right > windowPosition.left &&
				targetPosition.left < windowPosition.right) {

				sub.classList.add('block-with-substrate--visible');
			} else {
				sub.classList.remove('block-with-substrate--visible');
			};
		};
	...
	faqItems.forEach(item => {
		...
		let faqHead = item.querySelector('.faq__head');
		let height;

		faqBody.style.maxHeight = 'initial';
		raf(() => {
			height = faqBody.clientHeight;
		...
		faqHead.addEventListener("click", function () {
			if (activeFaq && activeFaq !== item) {
				...
				activeFaq.querySelector('.faq__body').style.maxHeight = null;
				activeFaq = null;
			}
			...
			if (faqBody.style.maxHeight) {
				...
				faqBody.style.maxHeight = height + 'px';

				activeFaq = item;
				// faqBody.addEventListener('transitionend', e => {
				// 	faqBody.style.maxHeight = null;
				// }, { once: true });
			}
		});
	...
	let classStages = document.querySelector('.classes-stages');
	let classStagesBtn = document.querySelector(".classes-stages__head");
	let classStagesBody = document.querySelector(".classes-stages__list");

	function showClassStages(sm) {
		if (sm.matches) {
			classStagesBtn.addEventListener("click", classStagesOpenHandler);

		} else {
			classStages.classList.remove("classes-stages--shown");
			classStagesBody.style.maxHeight = null;
			classStagesBtn.removeEventListener("click", classStagesOpenHandler);
		}
	}

	function classStagesOpenHandler() {
		if (classStages.classList.contains('classes-stages--shown')) {
			classStages.classList.remove("classes-stages--shown");
			classStagesBody.style.maxHeight = 0;
		} else {
			let height;
			classStagesBody.style.maxHeight = 'initial';

			raf(() => {
				height = classStagesBody.clientHeight;
				classStagesBody.style.maxHeight = null;

				raf(() => {
					classStages.classList.add("classes-stages--shown");
					classStagesBody.style.maxHeight = height + 'px';

					classStagesBody.addEventListener('transitionend', function (e) {
						classStagesBody.style.maxHeight = 'initial';
					})
				});
			});
		...
		if (forms[i] && window.FormData) {
			...
			form.addEventListener('submit', function (e) {
				...
				reqInputs.forEach(input => {
					...
					let reqMessage = parent.querySelector('.form__status');
					...
					switch (input.getAttribute("name")) {
						...
						case "name":
							if (input.value.length < 2) {
								...
								reqMessage = document.createElement('span');
								reqMessage.classList.add('form__status');
								reqMessage.textContent = "Поле должно быть заполнено";
								parent.appendChild(reqMessage);
					...
					if (reqMessage) {
						new DLAnimate().hide(reqMessage, {
							...
							afterLeave: function (reqMessage) {
								reqMessage.remove();
								parent.classList.remove('form__field--fault');
							}
						});
					}
				});
