!function(e, t) {
    ...
    function B(e, t, n) {
        var r, i, o = 0, a = yt.length, s = ie.Deferred().always(function() {
            ...
            if (i)
                return !1;
            for (var t = pt || _(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, a = 0, l = u.tweens.length; l > a; a++)
                u.tweens[a].run(o);
    ...
    var ue = function(e) {
        function t(e, t, n, r) {
            ...
            if ((t ? t.ownerDocument || t : P) !== H && L(t),
            t = t || H,
            n = n || [],
            s = t.nodeType,
        ...
        function b(e, n) {
            var i = n.length > 0
              ...
              , a = function(r, a, s, l, u) {
                var c, d, f, p = 0, h = "0", m = r && [], v = [], y = A, b = r || o && T.find.TAG("*", u), x = R += null == y ? 1 : Math.random() || .1, w = b.length;
        ...
        var x, w, T, C, N, E, k, S, A, D, j, L, H, _, q, M, F, O, B, W = "sizzle" + 1 * new Date, P = e.document, R = 0, $ = 0, z = n(), I = n(), X = n(), U = function(e, t) {
            return e === t && (j = !0),
            0
        ...
        try {
            K.apply(Y = Z.call(P.childNodes), P.childNodes),
        ...
        L = t.setDocument = function(e) {
            ...
            (w.qsa = ve.test(r.querySelectorAll)) && (i(function(e) {
                _.appendChild(e).innerHTML = "<a id='" + W + "'></a><select id='" + W + "-\f]' msallowcapture=''><option selected=''></option></select>",
            ...
            B = t || ve.test(_.contains) ? function(e, t) {
            ...
            U = t ? function(e, t) {
                ...
                1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === r || e.ownerDocument === P && B(P, e) ? -1 : t === r || t.ownerDocument === P && B(P, t) ? 1 : D ? ee(D, e) - ee(D, t) : 0 : 4 & n ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return j = !0,
        ...
        t.matchesSelector = function(e, n) {
            ...
            n = n.replace(de, "='$1']"),
            !(!w.matchesSelector || !q || F && F.test(n) || M && M.test(n)))
                try {
                    var r = O.call(e, n);
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, l) {
                        ...
                        if (g) {
                            ...
                            } else if (y && (u = (t[W] || (t[W] = {}))[e]) && u[0] === R)
                                f = u[1];
                            else
                                for (; (d = ++p && d && d[m] || (f = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[W] || (d[W] = {}))[e] = [R, f]),
                                d !== t)); )
                                    ;
                            return f -= i,
                            f === r || f % r === 0 && f / r >= 0
        ...
        S = t.select = function(e, t, n, r) {
            ...
            1 === d.length) {
                ...
                o.length > 2 && "ID" === (a = o[0]).type && w.getById && 9 === t.nodeType && q && T.relative[o[1].type]) {
            ...
            return (u || k(e, d))(r, t, !q, n, be.test(e) && c(t.parentNode) || t),
            n
        }
        ,
    ...
    ie.event = {
            ...
            if (g && (c = g.events)) {
                ...
                u = t.length; u--; )
                    ...
                    p) {
                        ...
                        l && !f.length && (d.teardown && d.teardown.call(e, h, g.handle) !== !1 || ie.removeEvent(e, p, g.handle),
                        delete c[p])
                    } else
                        for (p in c)
        ...
        trigger: function(t, n, r, i) {
            ...
            if (s = c = r = r || he,
            3 !== r.nodeType && 8 !== r.nodeType && !qe.test(p + ie.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."),
            p = h.shift(),
            h.sort()),
            a = p.indexOf(":") < 0 && "on" + p,
            ...
            i || !u.trigger || u.trigger.apply(r, n) !== !1)) {
                if (!i && !u.noBubble && !ie.isWindow(r)) {
                    ...
                    qe.test(l + p) || (s = s.parentNode); s; s = s.parentNode)
                        f.push(s),
                        c = s;
                ...
                if (t.type = p,
                !i && !t.isDefaultPrevented() && (!u._default || u._default.apply(f.pop(), n) === !1) && ie.acceptData(r) && a && r[p] && !ie.isWindow(r)) {
                    c = r[a],
                    c && (r[a] = null),
        ...
        fix: function(e) {
            ...
            for (a || (this.fixHooks[i] = a = _e.test(i) ? this.mouseHooks : He.test(i) ? this.keyHooks : {}),
            ...
            for (var i, o, a, s, l, u, c, d = e.length, f = m(t), p = [], h = 0; d > h; h++)
                ...
                o || 0 === o)
                    if ("object" === ie.type(o))
                        ...
                        i = c[0]; i--; )
                            s = s.lastChild;
                        if (!ne.leadingWhitespace && We.test(o) && p.push(t.createTextNode(We.exec(o)[0])),
                        !ne.tbody)
    ...
    ie.fn.extend({
        ...
        html: function(e) {
            return De(this, function(e) {
                ...
                if (!("string" != typeof e || Ie.test(e) || !ne.htmlSerialize && Be.test(e) || !ne.leadingWhitespace && We.test(e) || Ye[(Re.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Pe, "<$1></$2>");
                    try {
                        for (; r > n; n++)
                            t = this[n] || {},
        ...
        domManip: function(e, t) {
            ...
            if (p || u > 1 && "string" == typeof f && !ne.checkClone && Xe.test(f))
    ...
    ;
    var _t, qt, Mt = /#.*$/, Ft = /([?&])_=[^&]*/, Ot = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, Bt = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Wt = /^(?:GET|HEAD)$/, Pt = /^\/\//, Rt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, $t = {}, zt = {}, It = "*/".concat("*");
    try {
        qt = location.href
    } catch (e) {
    ...
    ie.extend({
        ...
        ajax: function(e, t) {
            ...
            w.success = w.done,
            w.error = w.fail,
            d.url = ((e || d.url || qt) + "").replace(Mt, "").replace(Pt, _t[1] + "//"),
            d.type = t.method || t.type || d.method || d.type,
            d.dataTypes = ie.trim(d.dataType || "*").toLowerCase().match(be) || [""],
            null == d.crossDomain && (r = Rt.exec(d.url.toLowerCase()),
            d.crossDomain = !(!r || r[1] === _t[1] && r[2] === _t[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (_t[3] || ("http:" === _t[1] ? "80" : "443")))),
    ...
    ie.fn.extend({
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || nn; e && !ie.nodeName(e, "html") && "static" === ie.css(e, "position"); )
                    e = e.offsetParent;
                return e || nn
            })
        }
...
jQuery(function(e) {
   function t() {
        ...
        t > 30 ? e("#header").addClass("fixed") : e("#header").removeClass("fixed")
    }
    ...
    e("#header_menu_btn").click(function() {
        return e("#header_menu").hasClass("active") ? (e("#header_menu").removeClass("active"),
        e("#header_menu").slideUp(200)) : (e("#header_menu").addClass("active"),
        e("#header_menu").slideDown(200)),
        !1
    }),
    e(window).load(function() {
        t(),
        window.innerWidth < 999 ? (e("#header_menu").removeClass("active"),
        e("#header_menu").hide()) : e("#header_menu").show()
    }),
    e(window).resize(function() {
        ...
        e("#header_menu").hide()) : e("#header_menu").show(),
        e("#map").length > 0) {
            var n = window.innerHeight - 472;
            window.innerHeight >= 768 && e(".contact-map, #map").css("height", n + "px")
        }
    }),
    window.lastScrollTop = 0,
    e(window).scroll(function() {
        return t(),
        window.lastScrollTop = e(window).scrollTop(),
        !1
    })
});
